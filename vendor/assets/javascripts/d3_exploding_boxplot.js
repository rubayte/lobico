...
function(d3,d3tip)
{
  ...
  var default_colors = ["#E6E6E6", "#F78181","#a6cee3","#ff7f00","#fdbf6f","#33a02c","#cab2d6","#6a3d9a","#fb9a99","#e31a1c","#ffff99","#b15928"];
	//var default_colors = ["#a6cee3","#ff7f00","#a6cee3","#ff7f00","#fdbf6f","#33a02c","#cab2d6","#6a3d9a","#fb9a99","#e31a1c","#ffff99","#b15928"];
